<x-app-layout>
    <div class="container mx-auto py-12 px-8">
        ...
        {{-- <div class="mb-4">
            <a href="{{ route('subjects.create') }}" class="bg-custom-purple text-sm text-white px-4 py-2 rounded-md">Add New Subject</a>
        </div> --}}


        <form action="{{ route('subjects.store') }}" method="POST" class="bg-white rounded-lg shadow">
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b">
                                <div class="flex items-center">
                                    <a href="{{ route('subjects.edit', $subject->id) }}" class="text-gray-500 hover:underline ml-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                        </svg>
                                    </a>
                                    <button class="delete-btn text-red-500 hover:underline ml-2" data-id="{{ $subject->id }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
