...
<?php endif; ?>
    <div class="absolute top-4 right-4">
        <a class="inline-flex items-center px-4 py-2 bg-custom-purple1 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-black focus:bg-black active:bg-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150" href="<?php echo e(route('login')); ?>">
            <?php echo e(__('User Login')); ?>

        </a>
    </div>
    <h3 class="text-center mb-3 mt-4">Admin Login Page</h3>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Laravel\management-project\management-project\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>