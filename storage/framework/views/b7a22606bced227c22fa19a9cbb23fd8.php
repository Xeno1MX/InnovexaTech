...
<?php $component->withAttributes([]); ?>
    <div class="container mx-auto py-12 px-8">
        ...
        <form action="<?php echo e(route('lecturers.store')); ?>" method="POST" class="bg-white rounded-lg shadow">
            <div class="p-4 bg-custom-purple rounded-tr-lg rounded-tl-lg">
                <h6 class="text-white text-sm">Add Lecturer</h6>
            </div>
            <?php echo csrf_field(); ?>
            ...
            <tbody>
                <?php if($lecturers->count() > 0): ?>
                    <?php $__currentLoopData = $lecturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lecturer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="py-2 px-4 border-b"><?php echo e($lecturer->id); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e($lecturer->name); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo e($lecturer->subject->name); ?></td>
                            <td class="py-2 px-4 border-b">
                                <div class="flex items-center">
                                    <a href="<?php echo e(route('lecturers.edit', $lecturer->id)); ?>" class="text-gray-500 hover:underline ml-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
                                        </svg>
                                    </a>
                                    <button class="delete-btn text-red-500 hover:underline ml-2" data-id="<?php echo e($lecturer->id); ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="py-2 px-4 border-b text-center text-gray-500">No Data</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
    ...
    <script>
        $(document).ready(function() {
            $('.delete-btn').click(function() {
                var id = $(this).data('id');
                $('#delete-form').attr('action', '/admin/lecturers/' + id);
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Laravel\management-project\management-project\resources\views/admin/lecturers/index.blade.php ENDPATH**/ ?>